...
>
> A newer generation, snow-run-python (written in Python for better portability), is available at https://github.com/chovanecm/snow-run-python. This repository will no longer be updated.
