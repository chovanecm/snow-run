...
# get security token
token=$(curl ${CURL_OPTIONS} https://$snow_instance/sys.scripts.do -b $SNOW_COOKIE_FILE --cookie-jar $SNOW_COOKIE_FILE -sS | extract_sysparm_ck)
if [[ -z $token ]]
then
